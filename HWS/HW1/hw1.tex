...
\item Return {\tt classname}, {\tt examname} and {\tt examdate} of
 ...
 \texttt{T2 = select\textunderscore{\string{examdate > 09-01-2020 and instructornname = `Fogg'}\string}} \\
 \texttt{Result = project\textunderscore{\string{classname, examname, examdate}\string} T2}
...
\texttt{Result = project\textunderscore{\string{classcode, classname}\string} T2 * Classes } \\
